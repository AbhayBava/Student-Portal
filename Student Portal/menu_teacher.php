...
$conn=mysqli_connect($servername,$username,$password,"$dbname");
	 $sql=mysqli_query($conn,"SELECT * FROM teacher where Id='$Id' and Password='$Password'");
